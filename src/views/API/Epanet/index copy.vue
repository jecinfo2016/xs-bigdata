            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="javascript:epanetjs.setMode(epanetjs.INPUT)">Input</a>
                  </li>
                  <li>
                    <a href="javascript:epanetjs.setMode(epanetjs.ANALYSIS)">Analysis</a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a href="javascript:epanetjs.setMode(epanetjs.ANALYSIS_SANKEY)">Sankey</a>
                  </li>
                </ul>
              </li>
              <!-- <li class="dropdown">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">
                  <span class="glyphicon glyphicon-cog" /> EPANET analysis in progress
                </h4>
              </div>
              <div class="modal-body">
                <p>
                  <span class="glyphicon glyphicon-time" /> Please wait...
                </p>
              </div>
              <div class="modal-footer">
        ...
        <div id="editMessage" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default btn-primary" onclick="editFun()">确定</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
